...
class  CsvToJson:
    ...
    def csv_to_dictionary(self,file_name:str,column_names:list,csv:pd.DataFrame,filtd_data:pd.array,encoding:str='utf-8')->dict:
        ...
        for col_1_item in col_1_list:
            ...
            try:
                ...
                col_1_dict[col_1_item]=main_info
                return col_1_dict
            except Exception as e:
                continue

    def csv_to_dictionary_2nd(self, file_name:str, column_names:list,encoding:str='utf-8',sep:str=',')->dict:
    ...
    def csv_to_json_2nd(self, file_name:str, column_names:str)->json:
        ...
        with open('./functions/'+self.file_name+'.json','w') as outfile:
            json.dump(self.csv_to_dictionary_2nd(file_name, column_names),outfile,indent=4,ensure_ascii=False)
